...
mult=1}
C {../CNR_ATR_SKY130NM/CNRATR_NCH_8C2F0.sym} 1162.5 880 0 0 {name=x2 }
C {../CNR_ATR_SKY130NM/CNRATR_NCH_8C2F0.sym} 1622.5 880 0 1 {name=x3 }
...
C {../CNR_ATR_SKY130NM/CNRATR_PCH_8C4F0.sym} 1002.5 610 0 1 {name=x8 }
C {../CNR_ATR_SKY130NM/CNRATR_PCH_8C2F0.sym} 1132.5 610 0 0 {name=x5 }
C {../CNR_ATR_SKY130NM/CNRATR_NCH_8C2F0.sym} 1352.5 1010 0 0 {name=x6 }
C {../CNR_ATR_SKY130NM/CNRATR_NCH_8C2F0.sym} 1122.5 1010 0 1 {name=x1 }
C {../CNR_ATR_SKY130NM/CNRATR_NCH_4C8F0.sym} 1002.5 1120 0 1 {name=x10 }
C {../CNR_ATR_SKY130NM/CNRATR_NCH_12C12F0.sym} 1752.5 1120 0 0 {name=x11 }
C {devices/isource.sym} 1042.5 805 0 0 {name=I0 value=3u}
C {devices/lab_pin.sym} 1360 950 0 0 {name=p7 sig_type=std_logic lab=p1}
C {devices/lab_pin.sym} 1240 1010 0 0 {name=p8 sig_type=std_logic lab=p2}
C {devices/lab_pin.sym} 1230 1120 0 0 {name=p9 sig_type=std_logic lab=p3}
C {devices/lab_pin.sym} 962.5 887.5 0 0 {name=p10 sig_type=std_logic lab=p4}
C {devices/lab_pin.sym} 1085 610 0 0 {name=p11 sig_type=std_logic lab=p5}
C {devices/lab_pin.sym} 1715 610 0 0 {name=p13 sig_type=std_logic lab=p6}
